                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdown1">
                        ...
                        <?php
                            ...
                            echo '<li><a class="dropdown-item" href="'.$url.$rutas[0].'/1/recientes">Más reciente</a></li>
                            <li><a class="dropdown-item" href="'.$url.$rutas[0].'/1/antiguos">Más antiguo</a></li>';
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php
                ...
                }else if($rutas[0] == "lo-mas-reciente"){
                        ...
                        if($pagProductos > 4){
                            ...
                            if($rutas[1] == 1){
                                ...
                                echo '<li class="page-item disabled"><a class="page-link">...</a></li> 
                                        ...
                                        <li class="page-item"><a class="page-link" href="'.$url.$rutas[0].'/2">
                                ...
                                echo '<ul class="pagination">
                                        ...
                                        <li class="page-item"><a class="page-link" href="'.$url.$rutas[0].'/'.($numPagActual-1).'">
                                ...
                                echo ' <li class="page-item"><a class="page-link" href="'.$url.$rutas[0].'/'.($numPagActual+1).'">
                                            <i class="fas fa-angle-right"></i>
                                        </a></li>                                   
                                    </ul>';
